# -*- coding: utf-8 -*-
"""
Created on Fri Nov  4 14:11:15 2022
...
file= root +"output_data/ML_lfes.json"
lfe_df=make_dataframe(file)
lfe_df.to_csv(root+"ML_Dataset/ML_lfe_timestamps.csv",index=False)
...
nolfe_df.to_csv(root+"ML_Dataset/ML_nolfe_timestamps.csv",index=False)

#dataframe with columns: 'start', 'end' and 'label' for all LFEs and non-LFEs
total_df=pd.concat([lfe_df,nolfe_df],axis=0)
total_df.to_csv(root+"ML_Dataset/ML_total_timestamps.csv",index=False)
